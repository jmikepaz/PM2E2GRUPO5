...
$idImagen = uniqid();
    ...
    $ruta = "http://167.99.158.191/examen/api/imagenes/". $idImagen . '.png';
}



    
$sql_query = "SELECT * FROM public.ft_actualizar_usuario('".$postdata."' , '".$ruta."')";
...
if (pg_send_query($con, $sql_query)) {
    ...
    if ($res) {
      ...
      if ($state==0) {
            ...
            $variable = (boolean)$datos[0]["ft_actualizar_usuario"];
